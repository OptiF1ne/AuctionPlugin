...
public class ConfirmMenu {
    public static final String TITLE_RAW = "Покупка лота | стр. %d";

    private final Auction plugin;
    private final AuctionItem lot;
    private final int returnPage; // чтобы вернуться на ту же страницу

    public ConfirmMenu(Auction plugin, AuctionItem lot, int returnPage) {
        this.plugin = plugin;
        this.lot = lot;
    ...
    public void open(Player player) {
        ...
        inv.setItem(11, button(Material.LIME_WOOL, "§aКупить"));
